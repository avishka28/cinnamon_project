...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="/admin/content/posts/create" class="btn btn-primary">
                        ...
                        <tbody>
                            <?php foreach ($posts as $post): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/admin/content/posts/<?= $post['id'] ?>/edit" 
                        ...
                        <ul class="pagination justify-content-center">
                            <?php for ($i = 1; $i <= $pages; $i++): ?>
                                <li class="page-item <?= $i === $currentPage ? 'active' : '' ?>">
                                    <a class="page-link" href="?page=<?= $i ?>&search=<?= urlencode($filters['search']) ?>&category=<?= $filters['category_id'] ?>&status=<?= $filters['status'] ?>">
                                        <?= $i ?>
                                    </a>
                                </li>
                            <?php endfor; ?>
