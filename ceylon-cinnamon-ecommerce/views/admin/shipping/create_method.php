...
<div class="container-fluid py-4">
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <form action="/admin/shipping/zones/<?= $zone['id'] ?>/methods" method="POST">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-text mb-2">Define specific costs for weight ranges. If set, these override the per-kg calculation.</div>
