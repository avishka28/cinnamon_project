...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?= url('/admin/shipping/zones/create') ?>" class="btn btn-primary">
    ...
    <?php foreach ($zones as $zone): ?>
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group">
                    <a href="<?= url('/admin/shipping/zones/' . $zone['id'] . '/methods/create') ?>" 
                       class="btn btn-sm btn-outline-primary">
                        <i class="bi bi-plus"></i> Add Method
                    </a>
                    <a href="<?= url('/admin/shipping/zones/' . $zone['id'] . '/edit') ?>" 
                        ...
                        <tbody>
                            <?php foreach ($zone['methods'] as $method): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= url('/admin/shipping/methods/' . $method['id'] . '/edit') ?>" 
                                           class="btn btn-sm btn-outline-secondary">
            ...
            <?php else: ?>
                <div class="card-body text-center py-4">
                    ...
                    <a href="<?= url('/admin/shipping/zones/' . $zone['id'] . '/methods/create') ?>" class="btn btn-sm btn-primary">
                        Add Shipping Method
                    </a>
                </div>
            <?php endif; ?>
...
function deleteZone(id) {
    ...
    fetch('<?= url('/admin/shipping/zones/') ?>' + id, {
        method: 'DELETE',
        headers: {
...
function deleteMethod(id) {
    ...
    fetch('<?= url('/admin/shipping/methods/') ?>' + id, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
            'X-Requested-With': 'XMLHttpRequest'
