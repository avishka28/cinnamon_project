<?php
/**
 * Admin Edit Shipping Method Form
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-0">Edit Shipping Method</h1>
...
<form action="<?= url('/admin/shipping/methods/' . $method['id']) ?>" method="POST">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="2"><?= htmlspecialchars($method['description'] ?? '') ?></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="base_cost" name="base_cost" 
                                       value="<?= number_format((float)$method['base_cost'], 2, '.', '') ?>" min="0" step="0.01">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="cost_per_kg" name="cost_per_kg" 
                                       value="<?= number_format((float)$method['cost_per_kg'], 2, '.', '') ?>" min="0" step="0.01">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="free_shipping_threshold" 
                               name="free_shipping_threshold" min="0" step="0.01" 
                               value="<?= $method['free_shipping_threshold'] !== null ? number_format((float)$method['free_shipping_threshold'], 2, '.', '') : '' ?>">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="weight-brackets">
                            <?php if (!empty($method['weight_brackets'])): ?>
                                <?php foreach ($method['weight_brackets'] as $bracket): ?>
                                    <div class="row mb-2 weight-bracket">
                                        <div class="col-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="min_order_amount" name="min_order_amount" 
                               min="0" step="0.01" 
                               value="<?= $method['min_order_amount'] !== null ? number_format((float)$method['min_order_amount'], 2, '.', '') : '' ?>">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="is_active" 
                                   name="is_active" value="1" <?= $method['is_active'] ? 'checked' : '' ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="sort_order" name="sort_order" 
                               value="<?= (int)$method['sort_order'] ?>" min="0">
                    </div>
                </div>
            </div>
